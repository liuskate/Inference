  ...
  public class Connection {
    ...
    public int readAndProcess() throws IOException, InterruptedException {
      while (true) {
        ...
        if (!rpcHeaderRead) {
          ...
          if (!isSecurityEnabled && authMethod != AuthMethod.SIMPLE && authMethod != AuthMethod.CONFIGFILE) {
          ...
          if ((authMethod != AuthMethod.SIMPLE) && (authMethod != AuthMethod.CONFIGFILE)) {
            useSasl = true;
          }
    ...
    private void processHeader(byte[] buf) throws IOException {
      ...
      if (!useSasl) {
        user = protocolUser;
        if (user != null) {
          if (protocolUser.isConfigFileEnabled()) {
            user.setAuthenticationMethod(AuthMethod.CONFIGFILE.authenticationMethod);
          } else {
