...
public class RPC {
  ...
  /**
   * A authorized exception
   */
  public static class NonAuthorizedException extends IOException {
  ...
  public static VersionedProtocol getProxy(
    ...
    if (serverVersion == clientVersion) {
      if (ticket.isSecurityEnabled()) {
        return proxy;
      }
      if (proxy.isAuthorized(protocol.getName())) {
        return proxy;
      } else {
        throw new NonAuthorizedException("The user is not authorized");
      }
    } else {
