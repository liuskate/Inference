...
public class Groups {
  ...
  public List<String> getGroups(String user) throws IOException {
    ...
    if (impl instanceof ConfigBasedGroupMapping) {
      groups = new CachedGroups(impl.getGroups(user), ((ConfigBasedGroupMapping)impl).getPassword(user));
    } else {
  ...
  private static class CachedGroups {
    ...
    CachedGroups(List<String> groups, String password) {
      this.groups = groups;
  ...
  public static GroupMappingServiceProvider getUserToGroupsMappingServiceImpl() {
    if (GROUPS != null) {
      return GROUPS.getImpl();
    }
    return null;
  }
}
