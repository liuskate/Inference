...
public class ClusterMetrics implements Writable {
  ...
  private int avarageMemoryUsage;
  private double avarageCpuUsage;
  private double avarageMapSlotUsage;
  private double avarageReduceSlotUsage;
  private double mapSlotFreeRate;
  private double reduceSlotFreeRate;
  ...
  public ClusterMetrics(int runningMaps, int runningReduces,
      ...
      int numDecommissionedNodes, int avarageMemoryUsage,
      double avarageCpuUsage, double avarageMapSlotUsage,
      double avarageReduceSlotUsage, double mapSlotFreeRate,
      double reduceSlotFreeRate) {
    ...
    this.avarageMemoryUsage = avarageMemoryUsage;
    this.avarageCpuUsage = avarageCpuUsage;
    this.avarageMapSlotUsage = avarageMapSlotUsage;
    this.avarageReduceSlotUsage = avarageReduceSlotUsage;
    this.mapSlotFreeRate = mapSlotFreeRate;
    this.reduceSlotFreeRate = reduceSlotFreeRate;
  }
  ...
  public int getAvarageMemoryUsage() {
    return avarageMemoryUsage;
  }

  public double getAvarageCpuUsage() {
    DecimalFormat df = new DecimalFormat("0.00"); 
    return Double.parseDouble(df.format(avarageCpuUsage)); 
  }

  public double getAvarageMapSlotUsage() {
    DecimalFormat df = new DecimalFormat("0.00"); 
    return Double.parseDouble(df.format(avarageMapSlotUsage)); 
  }

  public double getAvarageReduceSlotUsage() {
    DecimalFormat df = new DecimalFormat("0.00"); 
    return Double.parseDouble(df.format(avarageReduceSlotUsage)); 
  }

  public double getMapSlotFreeRate() {
    DecimalFormat df = new DecimalFormat("0.00"); 
    return Double.parseDouble(df.format(mapSlotFreeRate)); 
  }

  public double getReduceSlotFreeRate() {
    DecimalFormat df = new DecimalFormat("0.00"); 
    return Double.parseDouble(df.format(reduceSlotFreeRate)); 
  }
  ...
  public void readFields(DataInput in) throws IOException {
    ...
    avarageMemoryUsage = in.readInt();
    avarageCpuUsage = in.readDouble();
    avarageMapSlotUsage = in.readDouble();
    avarageReduceSlotUsage = in.readDouble();
    mapSlotFreeRate = in.readDouble();
    reduceSlotFreeRate = in.readDouble();
  }
  ...
  public void write(DataOutput out) throws IOException {
    ...
    out.writeInt(avarageMemoryUsage);
    out.writeDouble(avarageCpuUsage);
    out.writeDouble(avarageMapSlotUsage);
    out.writeDouble(avarageReduceSlotUsage);
    out.writeDouble(mapSlotFreeRate);
    out.writeDouble(reduceSlotFreeRate);
  }
