...
public class DefaultTaskController extends TaskController {
  ...
  @Override
  public void initializeJobFromCurrentVM(String user, String jobid,
                                     Path credentials, Path jobConf,
                                     TaskUmbilicalProtocol taskTracker) throws IOException, InterruptedException  {
    initializeJob(user, jobid, credentials, jobConf, taskTracker, null);
  }
