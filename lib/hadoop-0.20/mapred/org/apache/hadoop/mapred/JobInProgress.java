  ...
  throws IOException, InterruptedException {
    try {
      ...
      if (UserGroupInformation.isConfigFileEnabled()) {
        password = jobInfo.getPassword().toString();
        userUGI = UserGroupInformation.createConfigFileUser(user,password);
      } else {
      ...
      this.isTunnelJob = conf.getIsTunnel();
