...
public class TaskTrackerStatus implements Writable {
  ...
  /**
  * Set the current used physical memory usage on the tasktracker.
  * 
  * @param memoryUsage, memory usage, in byte unit.
  */
  void setMemoryUsage(int memoryUsage) {
    realMemoryUsage = memoryUsage;
  ...
  /**
   * Get the current physical memory usage on the tasktracker.
   * 
   * @return the physical memory usage on the tasktracker in percentage.
   */
