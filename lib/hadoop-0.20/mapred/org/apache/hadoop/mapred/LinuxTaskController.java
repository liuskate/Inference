...
class LinuxTaskController extends TaskController {
  ...
  @Override
  public void initializeJobFromCurrentVM(final String user, final String jobid, 
                                     final Path credentials, final Path jobConf,
    ...
    localizer.createLocalDirsWith2750();
    localizer.createUserDirsWith2750();
    localizer.createJobDirsWith2750();

    JobConf jConf = new JobConf(jobConf);
    localizer.createWorkDirWith2750(jConf);
    ...
    localizer.initializeJobLogDirWith2750();
