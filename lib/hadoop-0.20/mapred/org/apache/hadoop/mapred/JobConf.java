...
public class JobConf extends Configuration {
  ...
  /**
   * Set whether the job is tunnel job
   * @param tunnel true means it should be tunnel job
   */
  public void setIsTunnel(boolean tunnel) {
    setBoolean("mapred.job.istunneljob", tunnel);
  }
  
  /**
   * Get whether the job is tunnel job.
   * @return true if job is tunnel job.
   */
  public boolean getIsTunnel() {
    return getBoolean("mapred.job.istunneljob", false);
  }
