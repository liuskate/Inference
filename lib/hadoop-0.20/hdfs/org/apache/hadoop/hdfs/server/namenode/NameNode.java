...
public class NameNode implements ClientProtocol, DatanodeProtocol,
  ...
  */
  ...
  private Map<String, String> brokenDiskMap =  
  ...
  /** {@inheritDoc} */
  public boolean snapshot(String src, FsPermission masked, String clientName) throws IOException {
    stateChangeLog.debug("*DIR* NameNode.snapshot: " + src);
    String clientMachine = getClientMachine();

    return namesystem.snapshot(src, masked, clientName, clientMachine);
  }
  ...
  /**
   */
  public String[] getBrokenDiskList() {
    String[] ret = brokenDiskMap.values().toArray(new String[0]);
    return ret;
  }
  ...
  public DatanodeCommand[] sendHeartbeat(DatanodeRegistration nodeReg,
                                       ...
                                       int xmitsInProgress,
                                       int xceiverCount,
                                       String brokenDisk) throws IOException {
    verifyRequest(nodeReg);
    brokenDiskMap.put(nodeReg.name, brokenDisk);
